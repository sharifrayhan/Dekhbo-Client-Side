    ...
    return (
        <div>
            ...
            <Slider  {...settings}>
                ...
                <div>
                    <img src="https://i.ibb.co/b1JdJH2/amazon-prime-1.jpg" alt="" />
                </div>

                <div>
                    <img src="https://i.ibb.co/HqrTNSn/amazon-2.jpg" alt="" />
                </div>

                <div>
                    <img src="https://i.ibb.co/8dzwHh3/amazon-prime-3.jpg" alt="" />
                </div>
